...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <!-- Topbar -->
        <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow" style="background: rgb(54,3,116);
         background: linear-gradient(90deg, rgba(54,3,116,1) 5%, rgba(115,0,255,1) 100%);">
