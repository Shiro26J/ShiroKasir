...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header text-white" style="background: rgb(4,107,0);
            background: linear-gradient(90deg, rgba(4,107,0,1) 5%, rgba(62,218,3,1) 100%);">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header text-white" style="background: rgb(84,0,107);
            background: linear-gradient(90deg, rgba(84,0,107,1) 5%, rgba(179,0,255,1) 100%);">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header text-white" style="background: rgb(12,0,107);
            background: linear-gradient(90deg, rgba(12,0,107,1) 5%, rgba(0,40,255,1) 100%);">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header text-white" style="background: rgb(3,116,80);
            background: linear-gradient(90deg, rgba(3,116,80,1) 5%, rgba(0,255,93,1) 100%);">
